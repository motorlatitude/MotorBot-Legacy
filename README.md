...
Motorbot used a custom written library, called DiscordClient Library made in coffeescript and built for nodejs.

- [DiscordClient Documentation](https://motorlatitude.github.io/MotorBot/discordclient/#introduction/overview)
...
### SB (Soundboard)
  Command: `!sb`<br>
  Has Methods: `null`<br>
  Has Parameters: `pog, j3, gp, sb, wonder, wsr, 1, 2, 3, diddly`<br>
