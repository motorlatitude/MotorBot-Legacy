...
function streamify (uri, opt) {
  ...
  output.on('end', video.end.bind(video))
  output.on('close', video.end.bind(video))
  output.on('error', stream.emit.bind(stream, 'error'))
  output.on('end', stream.emit.bind(stream, 'end'))
  output.on('close', stream.emit.bind(stream, 'close'))
  return stream
}
