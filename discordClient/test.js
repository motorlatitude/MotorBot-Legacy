...
(function() {
  var DiscordClient, dc, musicStream, youtubeStream;
  ...
  dc.on("message", function(msg, channel_id, user_id, raw) {
    ...
    if (msg === "!v") {
      ...
      return yStream.on("info", function(info, format) {
        ...
        return musicStream.on('ready', function() {
          return dc.internals.servers["130734377066954752"].voice.play(musicStream);
        });
      });
    }
  });
